...
for i = 1, 8 do
    local str = "N" .. i
    -- node value为table，用于内置权重、慢启动参数
    nodes[str] = {
        weight = 100,
        start_time_in_millis = ngx.now(),
        slow_start_aggression = 0.3,
        slow_start_window_in_millis = 15,
    }
end
...
--for i = 0, 100 do
for _, i in ipairs({1,7}) do -- 权重上升
    local lowNode = "N8"
    nodes[lowNode]["weight"] = i
